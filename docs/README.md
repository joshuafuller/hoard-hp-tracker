...
| [design/button-states.html](design/button-states.html) | Rendered visual spec of button states | living (visual spec) |
| [design/dice-tray.md](design/dice-tray.md) | Dice-tray design notes | **living** |
| [design/dice-tray.html](design/dice-tray.html) | Rendered dice-tray visual study | living (visual spec) |
| [design/foil-gold-study.html](design/foil-gold-study.html) | CSS prototype of the brushed/foil-gold shimmer (the recipe DESIGN.md cites, #51) | living (visual spec) |
...
|-------|---------|--------|
| [spikes/dice-roller/](spikes/dice-roller/) | The dice-engine proof-of-concept PRD §5.3 + [dice-journeys](ux/dice-journeys.md) cite | reference (kept — cited) |
